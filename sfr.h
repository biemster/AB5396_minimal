...
//------------------------- XIP Cache controller -----------------------------//
#define XIP_CMD           SFR_RW (0x00054000)
#define XIP_CTRL          SFR_RW (0x00054004)
#define XIP_BASE          SFR_RW (0x00054010)
#define XIP_LIMIT         SFR_RW (0x00054014)
...
//------------------------- SFR Group6 ---------------------------------------//
#define GPIOASET        SFR_WO (0x00000600)
#define GPIOACLR        SFR_WO (0x00000604)
#define GPIOA           SFR_RW (0x00000608)
#define GPIOADIR        SFR_RW (0x0000060c)
#define GPIOADE         SFR_RW (0x00000610)
#define GPIOAFEN        SFR_RW (0x00000614)
#define GPIOADRV        SFR_RW (0x00000618)
#define GPIOAPU         SFR_RW (0x0000061c)
#define GPIOAPD         SFR_RW (0x00000620)
#define GPIOAPU200K     SFR_RW (0x00000624)
#define GPIOAPD200K     SFR_RW (0x00000628)
#define GPIOAPU300      SFR_RW (0x0000062c)
#define GPIOAPD300      SFR_RW (0x00000630)

#define GPIOBSET        SFR_WO (0x00000640)
#define GPIOBCLR        SFR_WO (0x00000644)
#define GPIOB           SFR_RW (0x00000648)
#define GPIOBDIR        SFR_RW (0x0000064c)
#define GPIOBDE         SFR_RW (0x00000650)
#define GPIOBFEN        SFR_RW (0x00000654)
#define GPIOBDRV        SFR_RW (0x00000658)
#define GPIOBPU         SFR_RW (0x0000065c)
#define GPIOBPD         SFR_RW (0x00000660)
#define GPIOBPU200K     SFR_RW (0x00000664)
#define GPIOBPD200K     SFR_RW (0x00000668)
#define GPIOBPU300      SFR_RW (0x0000066c)
#define GPIOBPD300      SFR_RW (0x00000670)

#define GPIOESET        SFR_WO (0x00000680)
#define GPIOECLR        SFR_WO (0x00000684)
#define GPIOE           SFR_RW (0x00000688)
#define GPIOEDIR        SFR_RW (0x0000068c)
#define GPIOEDE         SFR_RW (0x00000690)
#define GPIOEFEN        SFR_RW (0x00000694)
#define GPIOEDRV        SFR_RW (0x00000698)
#define GPIOEPU         SFR_RW (0x0000069c)
#define GPIOEPD         SFR_RW (0x000006a0)
#define GPIOEPU200K     SFR_RW (0x000006a4)
#define GPIOEPD200K     SFR_RW (0x000006a8)
#define GPIOEPU300      SFR_RW (0x000006ac)
#define GPIOEPD300      SFR_RW (0x000006b0)

#define GPIOFSET        SFR_WO (0x000006c0)
#define GPIOFCLR        SFR_WO (0x000006c4)
#define GPIOF           SFR_RW (0x000006c8)
#define GPIOFDIR        SFR_RW (0x000006cc)
#define GPIOFDE         SFR_RW (0x000006d0)
#define GPIOFFEN        SFR_RW (0x000006d4)
#define GPIOFDRV        SFR_RW (0x000006d8)
#define GPIOFPU         SFR_RW (0x000006dc)
#define GPIOFPD         SFR_RW (0x000006e0)
#define GPIOFPU200K     SFR_RW (0x000006e4)
#define GPIOFPD200K     SFR_RW (0x000006e8)
#define GPIOFPU300      SFR_RW (0x000006ec)
#define GPIOFPD300      SFR_RW (0x000006f0)

//------------------------- SFR Group7 ---------------------------------------//
#define GPIOGSET        SFR_WO (0x00000700)
#define GPIOGCLR        SFR_WO (0x00000704)
#define GPIOG           SFR_RW (0x00000708)
#define GPIOGDIR        SFR_RW (0x0000070c)
#define GPIOGDE         SFR_RW (0x00000710)
#define GPIOGFEN        SFR_RW (0x00000714)
#define GPIOGDRV        SFR_RW (0x00000718)
#define GPIOGPU         SFR_RW (0x0000071c)
#define GPIOGPD         SFR_RW (0x00000720)
#define GPIOGPU200K     SFR_RW (0x00000724)
#define GPIOGPD200K     SFR_RW (0x00000728)
#define GPIOGPU300      SFR_RW (0x0000072c)
#define GPIOGPD300      SFR_RW (0x00000730)

#define WKUPCON         SFR_RW (0x00000740)
#define WKUPEDG         SFR_RW (0x00000744)
#define WKUPCPND        SFR_WO (0x00000748)
#define PORTINTEDG      SFR_RW (0x0000074c)
#define PORTINTEN       SFR_RW (0x00000750)
#define WKPINMAP        SFR_RW (0x00000754)
#define SENSCON         SFR_RW (0x00000758)
#define SENSCPND        SFR_WO (0x0000075c)
#define SENSCNT         SFR_RW (0x00000760)
#define SENSCON1        SFR_RW (0x00000764)
#define BTCON2          SFR_RW (0x00000768)

#define WKRSRC          SFR_RO (0x00000780)
#define WKFSRC          SFR_RO (0x00000784)
#define BTSNFCNT        SFR_RO (0x00000788)
#define BTSNCLKN        SFR_RO (0x0000078c)
...
#define USERKEY         SFR_WO (0x00000880)
#define PROTCON1        SFR_WO (0x00000884)
